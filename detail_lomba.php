            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content">
                        <h4><?php echo htmlspecialchars($timeline['judul']); ?></h4>
                        <p><?php echo htmlspecialchars($timeline['deskripsi']); ?></p>
                        <small class="text-muted">
                            <?php 
                            $tanggal_mulai = date('d M Y', strtotime($timeline['tanggal_mulai']));
                            if ($timeline['tanggal_selesai']) {
                                $tanggal_selesai = date('d M Y', strtotime($timeline['tanggal_selesai']));
