    ...
    <div class="container">
        <div class="main-container">
            ...
            <div class="content-section">
                ...
                <div class="info-card">
                    <h5><i class="fas fa-calendar-alt"></i> Timeline Lomba</h5>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <div class="timeline-title"><?= htmlspecialchars($item['nama_timeline']) ?></div>
                            <div class="timeline-date">
                                <?= formatTanggal($item['tanggal_mulai']) ?> - <?= formatTanggal($item['tanggal_akhir']) ?>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
