...
<?php else: ?>
    ...
    <div class="text-center animate__animated animate__fadeInUp animate__delay-2s p-4 rounded shadow-sm bg-gradient">
        <h5 class="text-light mb-3">Ayo gabung dan ikuti berbagai lomba seru!</h5>
    ...
    <section id="about_us" class="py-5">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="text-muted mb-0">Merayakan kreativitas, kolaborasi, dan karya terbaik generasi muda.</p>
            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="d-flex align-items-center p-3 bg-light rounded">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Short video, infografis, robotik, dan lainnya</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="d-flex align-items-center p-3 bg-light rounded">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Kolaborasi karya lintas sekolah</small>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide p-3">
                    <img src="images/gallery/GQ1A1239.JPG" alt="Galeri 1" class="img-fluid rounded shadow-sm w-100 h-auto">
                </li>
                <li class="splide__slide p-3">
                    <img src="images/gallery/GQ1A1340.JPG" alt="Galeri 2" class="img-fluid rounded shadow-sm w-100 h-auto">
                </li>
                <li class="splide__slide p-3">
                    <img src="images/gallery/GQ1A1797.JPG" alt="Galeri 3" class="img-fluid rounded shadow-sm w-100 h-auto">
                </li>
                <li class="splide__slide p-3">
                    <img src="images/gallery/GQ1A1875.JPG" alt="Galeri 4" class="img-fluid rounded shadow-sm w-100 h-auto">
                </li>
                <li class="splide__slide p-3">
                    <img src="images/gallery/GQ1A1964.JPG" alt="Galeri 5" class="img-fluid rounded shadow-sm w-100 h-auto">
                </li>
            </ul>
        </div>
    </section>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="stats-card">
                            ...
                            <h3><?php echo count(array_filter($userPendaftaran, function($p) { return $p['status'] === 'confirmed'; })); ?></h3>
                    ...
                    <div class="col-12">
                        <?php if (empty($userPendaftaran)): ?>
                            <div class="empty-state">
                                ...
                                <a href="daftar.php" class="btn btn-daftar btn-lg">
