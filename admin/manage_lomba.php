    ...
    if ($action === 'add_timeline') {
        ...
        $timelines = [
            [
                ...
                'tanggal_mulai' => $_POST['pendaftaran_mulai'] ?? null,
                'tanggal_selesai' => $_POST['pendaftaran_akhir'] ?? null,
                'urutan' => 1
            ],
            [
                'judul' => 'Periode Seleksi',
                'deskripsi' => 'Tim juri akan melakukan seleksi terhadap karya yang telah dikumpulkan.',
                'tanggal_mulai' => $_POST['seleksi_mulai'] ?? null,
                'tanggal_selesai' => $_POST['seleksi_akhir'] ?? null,
                'urutan' => 2
            ],
            [
                'judul' => 'Pengumuman Pemenang',
                'deskripsi' => 'Pengumuman pemenang lomba akan dilakukan pada tanggal yang telah ditentukan.',
                'tanggal_mulai' => $_POST['pengumuman_mulai'] ?? null,
                'tanggal_selesai' => $_POST['pengumuman_akhir'] ?? null,
                'urutan' => 3
            ]
        ];
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" class="form-control" name="pendaftaran_mulai" id="pendaftaran_mulai">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Tanggal Akhir</label>
                                                        <input type="date" class="form-control" name="pendaftaran_akhir" id="pendaftaran_akhir">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label class="form-label">Tanggal Mulai</label>
                                                        <input type="date" class="form-control" name="seleksi_mulai" id="seleksi_mulai">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Tanggal Akhir</label>
                                                        <input type="date" class="form-control" name="seleksi_akhir" id="seleksi_akhir">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label class="form-label">Tanggal Mulai</label>
                                                        <input type="date" class="form-control" name="pengumuman_mulai" id="pengumuman_mulai">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Tanggal Akhir</label>
                                                        <input type="date" class="form-control" name="pengumuman_akhir" id="pengumuman_akhir">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
