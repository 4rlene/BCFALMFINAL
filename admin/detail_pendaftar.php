                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-white border-0">
                                    <h5 class="mb-0">
                                        <i class="fab fa-instagram me-2 text-danger"></i>Bukti Follow Instagram - Ketua Tim
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-info mb-3">
                                        <i class="fas fa-info-circle me-2"></i>
                                        <strong>Ketua Tim:</strong> <?= htmlspecialchars($pendaftar['nama']) ?>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <h6 class="text-info">@smkbl.verse</h6>
                                                <?php if (!empty($anggota['ig_smkblverse_proof'])): ?>
                                                    <img src="../uploads/<?= htmlspecialchars($anggota['ig_smkblverse_proof']) ?>" 
                                                         alt="Bukti Follow @smkbl.verse - <?= htmlspecialchars($anggota['nama']) ?>" 
                                                         class="img-fluid rounded mb-2" style="max-height: 150px;">
                                                    <button class="btn btn-sm btn-outline-danger" 
                                                            data-bs-toggle="modal" 
                                                            data-bs-target="#igProofModal"
